            ...
            <div class="col-md-6">
                <div class="form-container">
                    ...
                    <%
                        ...
                        if (car == null) {
                            out.println("<div class='alert alert-danger'>Car not found.</div>");
                        } else {
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="driverId" name="driverId" required>
                                ...
                                <% for (Driver driver : drivers) { %>
                                    <option value="<%= driver.getDriverId() %>" <%= driver.getDriverId() == car.getDriverId() ? "selected" : "" %>>
                                        <%= driver.getName() %>
                                    </option>
                                <% } %>
                            </select>
                        </div>
                        <button type="submit" class="btn btn-submit">Update Car</button>
                    </form>
                    <% } %>
                </div>
            </div>
