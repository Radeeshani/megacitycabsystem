        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="table-container">
                    <h2>Car List</h2>
                    <a href="${pageContext.request.contextPath}/cars?action=add" class="btn btn-primary mb-3">Add Car</a>
                               ...
                               for (Car car : cars) { %>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="${pageContext.request.contextPath}/cars?action=delete&id=<%= car.getCarId() %>" class="btn btn-danger btn-action" onclick="return confirm('Are you sure you want to delete this car?');">Delete</a>
                                    </td>
                                </tr>
                            <% } %>
                        </tbody>
