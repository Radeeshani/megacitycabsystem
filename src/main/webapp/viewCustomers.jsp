                               ...
                               for (Customer customer : customers) { %>
                                <tr>
                                    ...
                                    <td>
									    ...
									    <a href="customers?action=delete&id=<%= customer.getCustomerId() %>" class="btn btn-danger btn-action" onclick="return confirm('Are you sure you want to delete this customer?');">Delete</a>
									</td>
                                </tr>
                            <% } %>
                        </tbody>
