                               ...
                               if (users != null) {
                                   for (User user : users) { %>
                                    <tr>
                                        ...
                                        <td><%= user.getRole() %></td>
                                        <td>
                                            <a href="${pageContext.request.contextPath}/users?action=edit&id=<%= user.getUserId() %>" class="btn btn-primary btn-sm btn-action">Edit</a>
                                            <a href="${pageContext.request.contextPath}/users?action=delete&id=<%= user.getUserId() %>" class="btn btn-danger btn-sm btn-action" onclick="return confirm('Are you sure you want to delete this user?')">Delete</a>
                                        </td>
                                    </tr>
                                <% }
                               } else { %>
